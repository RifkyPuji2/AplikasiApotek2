package com.example.aplikasiapotek;
...
import com.example.aplikasiapotek.adapter.MainAdapter;
...
public class MainActivity extends AppCompatActivity implements MainAdapter.FirebaseDataListener {
    ...
    private void dialogTambahBarang() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(this);
        builder.setTitle("Tambah Data Obat");
        View view = getLayoutInflater().inflate(R.layout.layout_edit_barang, null);

        mEditNama = view.findViewById(R.id.nama_obat);
        mEditMerk = view.findViewById(R.id.jenis_obat);
